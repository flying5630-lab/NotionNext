...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '北洋水师的成长家园', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || ''https://49st.us.ci/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，这里是北洋水师学习、成长的家园,欢迎来到我的博客🎉',

  // uuid重定向至 slug
  UUID_REDIRECT: process.env.UUID_REDIRECT || false
// 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '13833641@qq.com', // 邮箱地址 例如mail@tangly1024.com
...
CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/470705977', // B站主页
